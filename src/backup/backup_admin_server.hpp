...
private:
  ...
  std::string public_config_response();
  std::string list_response( bool remote );
  std::string public_list_response();
  ...
  std::string public_restore_fetch_response( const std::string& body );
  std::string restore_preflight_response( const std::string& body );
  std::string public_restore_preflight_response( const std::string& body );
